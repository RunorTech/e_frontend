    ...
    <section className={`${styles.backgroundImgHero} w-full h-screen `}>
      <div className="h-full  backdrop-blur-sm bg-black/30 flex items-center ">
        <div className=' container mx-auto flex flex-col gap-10 px-4 '>
          <div>
            <div className='flex gap-2'><h1 className='text-3xl text-white font-bold'>BULKFOOD</h1><span className='text-4xl  rotate-45 '><PiChefHatThin /></span></div>
          ...
          <div className=''>
            ...
            <div className='flex w-full text-white justify-between  gap-4'>
